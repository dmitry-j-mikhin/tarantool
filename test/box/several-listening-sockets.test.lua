...
fiber = require('fiber')
test_run = env.new()
test_run:cmd("create server test with script='box/several-listening-sockets.lua'")
...
function check_connection_for_several_uris()
    local uris_table = {}
    local uris_with_options_table = test_run:eval('test', 'return box.internal.modify_cfg.listen')[1]
...
for thread_count = 1, 3 do
    for listen_count = 1, 2 do
        test_run:cmd(string.format("start server test with args=\"%d\"", thread_count))
...
function listen_with_valid_uri(idx)
    ...
    local valid_uris = {
        ...
        { { uri = string.format("%s", default_server_addr), transport = 'plain; plain' } },
        { { uri = string.format("%s", default_server_addr), transport = 'plain;plain;plain' } },
    }
...
test_run:cmd("setopt delimiter ';'")
idx = 1;
while test_run:eval('test', string.format("return listen_with_valid_uri(%d)", idx))[1] do
    local uris_table = check_connection_for_several_uris()
    assert(uris_table)
    assert(check_graceful_unix_socket_path_unlink(uris_table))
    idx = idx + 1
...
function listen_with_invalid_uri(idx)
    ...
    local invalid_uries_corresponding_errors = {
        "Incorrect value for option 'listen': URI table can't be empty",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': invalid option value 'unexpected_value' for URI 'transport' option",
        "Incorrect value for option 'listen': keys in the URI table can be numbers or strings, but not a combination of them",
        "Incorrect value for option 'listen': invalid option value '' for URI 'transport' option",
        "Incorrect value for option 'listen': not found value for URI 'plain' option",
        "Incorrect value for option 'listen': invalid option name 'unexpected_option' for URI",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': invalid option name '/transport' for URI",
        "Incorrect value for option 'listen': missing URI",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': invalid option value 'plain=transport=plain' for URI 'transport' option",
        "Incorrect value for option 'listen': invalid option value 'plain?transport=plain' for URI 'transport' option",
        "Incorrect value for option 'listen': dublicate listen URI",
        "Incorrect value for option 'listen': missing URI options after '?'",
        "Incorrect value for option 'listen': not found value for URI '" .. default_server_addr .. "' option",
        "Incorrect value for option 'listen': missing URI options after '?'",
        "Incorrect value for option 'listen': dublicate listen URI",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': URI should be a string",
        "Incorrect value for option 'listen': invalid option name 'unexpected_option' for URI",
        "Incorrect value for option 'listen': invalid option value 'plain, plain' for URI 'transport' option",
        "Incorrect value for option 'listen': keys in the URI table can be numbers or strings, but not a combination of them",
        "Incorrect value for option 'listen': not found value for URI '??' option",
        "Incorrect value for option 'listen': missing URI options after '?'",
        "Incorrect value for option 'listen': expected host:service or /unix.socket",
        "Incorrect value for option 'listen': missing URI options after '?'",
        "Incorrect value for option 'listen': dublicate listen URI",
    ...
    if invalid_uries[idx] then
        local rc, err = pcall(box.cfg, { listen = invalid_uries[idx] })
        local result = { rc, err, invalid_uries_corresponding_errors[idx] }
        return result
    end
end$
test_run:cmd("setopt delimiter ''")$
...
idx = 1;
while true do
    local result = test_run:eval('test', string.format("return listen_with_invalid_uri(%d)", idx))[1]
    if not result then
        break
    end
