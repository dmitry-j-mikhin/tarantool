...
pgroup:add('test_replica_is_orphan_after_restart', function()
    ...
    t.helpers.retrying({timeout = 20},
        function()
            ...
            t.assert(fio.path.exists(SOCKET_DIR .. '/ready_' .. quorum1.alias))
        end
    )
...
pgroup:add('test_master_master_works', function()
    ...
    t.helpers.retrying({timeout = 20},
        function()
            ...
            t.assert(fio.path.exists(SOCKET_DIR .. '/ready_' .. master_quorum2.alias))
        end
    )
...
pgroup:add('test_quorum_during_reconfiguration', function()
    ...
    t.helpers.retrying({timeout = 20},
        function()
            ...
            t.assert(fio.path.exists(SOCKET_DIR .. '/ready_' .. replica_quorum.alias))
